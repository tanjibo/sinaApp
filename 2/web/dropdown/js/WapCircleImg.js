...
(function (window, undefined) {
    ...
    TouchSlider.prototype = {
        ...
        resize: function () {
            ...
            //改变高度位置
           //this.height = (200 * this.width) /320;
...
function WapCircleImg_02(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
     ...
     'before': function (index) {
        //var arry_li_on_name = document.getElementsByName("li_on_name");
        var arry_li_on_name = document.getElementById("btn_list_current").getElementsByTagName("span");
        //console.log(arry_li_on_name)
        //alert(arry_li_on_name.length);
        for (var i = 0; i < arry_li_on_name.length; i++) {
            if (i == index) arry_li_on_name[i].className = "btn_current";
            else arry_li_on_name[i].className = "";
        }
    },
    "after": function (index) {
...
function WapCircleImg_one(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
        ...
        'before': function (index) {
            //var arry_li_on_name = document.getElementsByName("li_on_name");
            var arry_li_on_name = document.getElementById("btn_list_current1").getElementsByTagName("span");
            //console.log(arry_li_on_name)
            //alert(arry_li_on_name.length);
            for (var i = 0; i < arry_li_on_name.length; i++) {
                if (i == index) arry_li_on_name[i].className = "btn_current";
...
function WapCircleImg_04(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
        ...
        'before': function (index) {
            //var arry_li_on_name = document.getElementsByName("li_on_name");
            var arry_li_on_name = document.getElementById("btn_list_current0").getElementsByTagName("span");
            //console.log(arry_li_on_name)
            //alert(arry_li_on_name.length);
            for (var i = 0; i < arry_li_on_name.length; i++) {
                if (i == index) arry_li_on_name[i].className = "btn_current";
...
function WapCircleImg_05(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
...
function footlist(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
	    ...
	    'before': function (index) {
	        ...
	        for (var i = 0; i < arry_li_on_name.length; i++) {
	            if (i == index) arry_li_on_name[i].className = "btn_current";
	            else arry_li_on_name[i].className = "btn_one";
	        }
	    },
	    "after": function (index) {
	    }
...
function WapCircleImg_07(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
...
function WapCircleImg_08(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
...
function WapCircleImg_09(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
...
function WapCircleImg_10(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
...
function WapCircleImg_11(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
        ...
        'before': function (index) {
            ...
            //alert(arry_li_on_name.length);
            for (var i = 0; i < arry_li_on_name.length; i++) {
                if (i == index) arry_li_on_name[i].className = "li_current";
                else arry_li_on_name[i].className = "top_kinds_detail";
            }
        },
        "after": function (index) {
        }
...
function WapCircleImg_13(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
...
function gdhs(listid, count, isauto) {
    var PicPlay = document.getElementById(listid);
    PicPlay.main_pic_scroll = new TouchSlider({
        id: listid,
        'auto': isauto ? 0 : -1,
...
function showdiv(targetid,objN){
    ...
    var zhezhao=document.getElementById("menban");
...
//		var loginTop = $(".footer_b").offset().top;
//		var toTop 		= $(document).scrollTop();
//		var r = totalHeight - toTop;
//		
//		var loginH = $(".footer_b").height();
//		var meiTop = $(".my_meijing").offset().top;
//		var meiH = 36;//图片的高度
//		var dis = loginTop - meiTop;//得到起始位置
//
//		var bottomCss = $(".my_meijing").css("bottom");//Bottom位置值
//		var bottomCss = bottomCss.replace('px', '');//取得纯数字 如36px -> 36
//		bottomCss = parseInt(bottomCss);//变更基本类型 String -> int。String如英文、汉字、符号等，int。如1,-1等。区别在于String 1+ String 2 = 12。int 1 + int 2 = 3;
//		if(dis < meiH)//若"美"起始位置小于 图片高度，则进入if语句
//		{
//			if(dis >= 0)//若"美"起始位置大于、等于0。 暂时看不出来效果，等待进一步测试。by xiaoxin。
//			{
//				bottomCss = bottomCss - dis ;
//				$(".my_meijing").attr("style", "bottom:" + bottomCss + "px");
//			}
//			else //若"美"起始位置小于0 。若取消此行代码，"美"字可出现在页面底部。
//			{
//				//总高度减去 mei高度
//				dis = -dis;
//				bottomCss = bottomCss + dis;
...
//			if(bottomCss < dis)
//			{
//				$(".my_meijing").css({bottom:"0px"});
//			}
//			else
//			{
//				bottomCss = bottomCss - dis;
//				$(".my_meijing").css({bottom:bottomCss+"px"});
//			}
//		}
//	}
//);
